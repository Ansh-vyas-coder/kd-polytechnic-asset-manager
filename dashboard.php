        ...
        <div class="lg:col-span-1 bg-white rounded-xl shadow-sm border border-gray-100 p-5 lg:p-6 flex flex-col">
          ...
          <div class="flex-1 flex items-end justify-between gap-3 min-h-[180px]">
            <div class="flex flex-col items-center gap-2 flex-1">
              <span class="text-[11px] font-semibold text-gray-600">1,248</span>
              <div class="w-full max-w-[34px] bg-blue-500 rounded-t-md" style="height:180px"></div>
              <span class="text-[11px] text-gray-400">Expandable</span>
            </div>
            <div class="flex flex-col items-center gap-2 flex-1">
              <span class="text-[11px] font-semibold text-gray-600">450</span>
              <div class="w-full max-w-[34px] bg-blue-500 rounded-t-md" style="height:120px"></div>
              <span class="text-[11px] text-gray-400">Consumables</span>
            </div>
            <div class="flex flex-col items-center gap-2 flex-1">
              <span class="text-[11px] font-semibold text-gray-600">156</span>
              <div class="w-full max-w-[34px] bg-blue-500 rounded-t-md" style="height:109px"></div>
              <span class="text-[11px] text-gray-400">Furniture</span>
            </div>
            <div class="flex flex-col items-center gap-2 flex-1">
              <span class="text-[11px] font-semibold text-gray-600">34</span>
              <div class="w-full max-w-[34px] bg-blue-500 rounded-t-md" style="height:79px"></div>
              <span class="text-[11px] text-gray-400">Deadstock</span>
            </div>
          </div>
        </div>
        </div>
